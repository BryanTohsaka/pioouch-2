...
const ContactButtons: React.FC = () => {
  ...
  const toggleWhatsAppOptions = (): void => {
  ...
  return (
    <div className="font-sans flex justify-start items-center bg-gray-100 pl-5 transition-all">
      ...
      <div className="fixed bottom-5 left-5 flex flex-col gap-3 max-w-[60vw] z-20 ">
        ...
        <div
          id="whatsapp-options"
          className={`flex flex-col gap-2 bg-white p-3 rounded-lg shadow-md absolute bottom-20 left-1/2 transform -translate-x-1/2 w-48 z-30 ${
            isMenuOpen ? 'flex' : 'hidden'
          }`}
        >
          <h3 className="text-sm font-bold pb-2">Selecciona tu sucursal:</h3>
          <a href="#" className="text-black px-2 py-1 bg-gray-100 rounded-md hover:bg-gray-200">
            Coapa
          </a>
          <a href="#" className="text-black px-2 py-3 bg-gray-100 hover:bg-gray-200 border-y-2 border-grey">
            Iztapalapa
          </a>
          <a href="#" className="text-black px-2 py-1 bg-gray-100 rounded-md hover:bg-gray-200">
            Mixcoac
